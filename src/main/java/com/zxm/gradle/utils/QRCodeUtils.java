...
public class QRCodeUtils {
    ...
    public static void main(String[] args) throws Exception {
        String text = "https://epro-ps231-hx.test.viewchain.net/#/hospital/kanban";  //这里设置自定义网站url
        String logoPath = "C:\\Users\\Administrator\\Desktop\\laker.jpg";
